...
const MainContent = () => {
    ...
    return(
        <div>
            ...
            <div className="menu-item item-description">Miso, corn, bean sprouts, cabbage, onion, scallion, ground pork, roasted pork, noodle</div>
            ...
            <div className="menu-item">(Chicken broth)</div>
            <div className="menu-item item-description">Spicy oil, miso, corn, bean sprouts, cabbage, onion, scallion, ground pork, roasted pork</div>
            ...
            <div className="menu-item item-description">Miso, kimchi, onion, bean sprouts, cabbage, scallion, corn, sea weed, bamboo, noodle</div>
            ...
            <div className="menu-item item-description">Sesame paste, white truffle oil, parmesan cheese, ground pork, seasoned boiled egg, crunchy onions, scallion, chili oil</div>
            ...
            <div className="menu-item item-description">Bacon, cabbage, crunchy tempura flake, egg, scallion, original teriyaki sauce, mayonnaise, dry seaweed, bonito flake, flour</div>

            <div className="menu-head">
                <span className="content">Kobe Beef Burger</span>
                <span className="price">$12</span>
            </div>
            <div className="menu-item item-description">Kobe ground beef, romaine lettuce, cheese, tomato, scallion, original bbq sauce, spicy mayonnaise</div>
            {/* {displayMains} */}
